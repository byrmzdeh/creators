  ...
  return (
    <div className='footer'>
      ...
      <div className="footer-one">
        ...
        <h1>TALKING</h1>
        <p>Nunc ultrices tellus et libero pretium, id mollis diam bibendum. <br /> Pellentesque pellentesque, erat ut sagittis
          euismod, mauris <br /> nunc iaculis ligula, eu tempus nunc ex at lacus</p>
